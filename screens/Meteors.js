...
import { Text, View,Alert, Dimensions,StyleSheet,Platform,StatusBar,Image } from 'react-native';
...
export default class MeteorScreen extends Component {
    ...
    constructor(props){
        ...
        getMeteors=()=>{
          axios
            .get("https://api.nasa.gov/neo/rest/v1/feed?api_key=EmSrHyBfB0GFVJv7EBZDB0Y9u8hwk0i7k89EXwxg")  
            .then(response=>{
                        ...
                        <ImageBackground source={bg_image} style={styles.backgroundImage}>
                            <View style={styles.gifContainer}>
                                ...
                                <View>
                                    ...
                                    <Text style = {[styles.cardText,{marginTop:5,marginLeft:50}]}>
                                        Missing Earth BY(kilometers)-{item.close_approach_data[0].missed_distance.kilometers}
                                    </Text>
    ...
    render() {
        if(Object.keys(this.state.location).length===0){
            ...
            meteors.forEach(function(element){
                ...
                let threatScore=(diameter/element.close_approach_data[0].missed_distance.kilometers)*1000000000
